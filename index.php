...
switch ($page) {
	...
	case 'slots_game':
		...
		if(count($details) >= 3) {
			echo '<script>let SLOTS_GAME_PROVIDER="'.$details[1].'";let SLOTS_GAME_ID="'.$_GET["id"].'";SLOTS_GAME_PROVIDER = SLOTS_GAME_PROVIDER.replaceAll("___", "");SLOTS_GAME_ID = SLOTS_GAME_ID.replaceAll("___", "-");</script>';
		}
