					...
					<div class="mt-2 mb-2">
						<div class="flex justify-center items-center gap-1">
							...
							<div class="text-left text-gray">
								...
								<div>And receive <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['google']); ?> coins</span></div>
							</div>
						</div>
					</div>
				...
				<div class="flex column justify-between height-full">
					...
					<div class="mt-2 mb-2">
						<div class="flex justify-center items-center gap-1">
							...
							<div class="text-left text-gray">
								<div>Link your <span class="text-color">Steam</span> to your account</div>
								<div>And receive <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['steam']); ?> coins</span></div>
							</div>
						</div>
					</div>
					
					<?php if(!$profile['binds']['steam']){ ?>
					<a href="<?php echo $site['root'];?>auth/steam?assign=1&return=<?php echo $site['path'];?>">
						<button class="site-button purple width-full">Connect</button>
					</a>
					<?php } else if($rewards['rewards']['collected_steam']){ ?>
					<button class="site-button disabled purple width-full">Collected</button>
					<?php } else { ?>
					<button class="site-button purple width-full" id="collect_reward_bind" data-bind="steam">Collect</button>
					<?php } ?>
				</div>
			</div>
				...
				<div class="flex column justify-between height-full">
					...
					<div class="mt-2 mb-2">
						<div class="flex justify-center items-center gap-1">
							...
							<div class="text-left text-gray">
								<div>Link your <span class="text-color">Facebook</span> to your account</div>
								<div>And receive <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['facebook']); ?> coins</span></div>
							</div>
						</div>
					</div>
					
					<?php if(!$profile['binds']['facebook']){ ?>
					<a href="<?php echo $site['root'];?>auth/facebook?assign=1&return=<?php echo $site['path'];?>">
						<button class="site-button purple disabled width-full">Connect (coming soon)</button>
					</a>
					<?php } else if($rewards['rewards']['collected_facebook']){ ?>
					<button class="site-button disabled purple width-full">Collected</button>
					<?php } else { ?>
					<button class="site-button disabled purple width-full" id="collect_reward_bind" data-bind="facebook">Collect</button>
					<?php } ?>
				</div>
			</div>
		</div>
		...
		<div class="grid responsive split-column-3 gap-1">
			<div class="bg-light-transparent rounded-1 b-l2 p-2">
				<div class="flex column justify-between height-full">
					...
					<div class="text-gray mt-2 mb-2">
						<div>Deposit at least <span class="text-color">5.00 coins</span> in the last <span class="text-color">7 days</span> to earn up to <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['daily_start'] + 100 * $rewards['amounts']['daily_step']); ?> coins</span> daily</div>
						<div>The amount is based by your level. The amount starts from <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['daily_start']); ?> coins</span> and each level increase with <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['daily_step']); ?> coins</span></div>
					</div>
			...
			<div class="bg-light-transparent rounded-1 b-l2 p-2">
				<div class="flex column justify-between height-full">
					...
					<div class="mt-2 mb-2">
						<div class="text-gray mb-2">Use any referral code and receive <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['refferal_code']); ?> coins</span></div>
			...
			<div class="bg-light-transparent rounded-1 b-l2 p-2">
				<div class="flex column justify-between height-full">
					...
					<div class="mt-2 mb-2">
						<div class="text-gray">Create and share your referral code to give <span class="text-color"><?php echo getFormatAmountString($rewards['amounts']['refferal_code']); ?> coins</span></div>
